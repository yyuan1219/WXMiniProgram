...
__DEFINE__(1681023392374, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1681023392375,"./event-store":1681023392376}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1681023392375, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1681023392376, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1681023392375,"./utils":1681023392377}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1681023392377, function(require, module, exports) {
...
return __REQUIRE__(1681023392374);
})()
